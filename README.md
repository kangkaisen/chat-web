...
> Default: Empty
> Example: `+llama,+claude-2,-gpt-3.5-turbo-1106,gpt-4-1106-preview=gpt-4-turbo` means add `llama, claude-2` to model list, and remove `gpt-3.5-turbo-1106` from list, and display `gpt-4-1106-preview` as `gpt-4-turbo`.
